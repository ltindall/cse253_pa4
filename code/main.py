...
predicted_chars, hidden_activations = my_models.generate(h.save_file, lstm, h.temperature, h.prediction_length, h.generate_best_file, h.till_end)
_,_ = my_models.generate(h.save_file_progress, lstm, h.temperature, h.prediction_length, h.generate_last_file, h.till_end)



# uncomment these two lines for neuron visualizations 
#map_height = int(h.prediction_length / h.map_width)
#my_models.visualize(predicted_chars, hidden_activations, map_width=h.map_width, map_height=map_height)
